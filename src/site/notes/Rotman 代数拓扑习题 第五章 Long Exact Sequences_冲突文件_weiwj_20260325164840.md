---
{"dg-publish":true,"permalink":"/Rotman 代数拓扑习题 第五章 Long Exact Sequences_冲突文件_weiwj_20260325164840/","tags":["代数"]}
---
...
3. **代入序列得出结论**： 将上述结果代入正合序列，得到一个短正合列： $$0 \to \mathbb{Z} \xrightarrow{j_*} H_1(S^1, S^0) \xrightarrow{\partial} \mathbb{Z} \to 0$$ 由于右侧的 $\mathbb{Z}$ 是**自由阿贝尔群**，该短正合列必定分裂（Split）。 因此： $$H_1(S^1, S^0) \cong \mathbb{Z} \oplus \mathbb{Z}$$
