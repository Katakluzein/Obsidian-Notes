---
{"dg-publish":true,"permalink":"/2 项目笔记/不定因果/项目：ICO metrology 单参数估计的渐近行为/","tags":["不定因果与因果结构","量子精密测量"]}
---
...
- [[不定因果×单参数估计量子精密测量的数学概要\|不定因果×单参数估计量子精密测量的数学概要]]
...
### 证明思路6：利用置换对称性约化问题
[[利用置换对称性约化ICO-QFI\|利用置换对称性约化ICO-QFI]] 
