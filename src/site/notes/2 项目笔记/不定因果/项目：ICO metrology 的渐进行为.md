---
{"dg-publish":true,"permalink":"/2 项目笔记/不定因果/项目：ICO metrology 的渐进行为/","tags":["不定因果与因果结构","量子精密测量"]}
---
...
$$
其中 $\alpha_h$ 和 $\beta_h$ 是通过对单个信道 $\mathcal{E}_g$ 的Kraus算符进行 $h$-参数化变换后得到的算符。这个界限揭示了两种不同的渐近标度行为：
...
- ICO无优势
	 - z轴旋转+比特翻转噪声，可以完全纠正掉，得到最好的QFI，这种情况下应该不可能通过ICO获得更高的QFI [[new avai SPD data generation simCmdC0.nb\|new avai SPD data generation simCmdC0.nb]] z轴旋转+比特翻转没有任何优势，达到海森堡极限的噪声信道
