...
#### 4. D 型: 偶数维特殊正交李代数 $\mathfrak{so}(2n, \mathbb{C})$
...
- [[Introduction to Haar Measure Tools in Quantum Information A Beginner's Tutorial\|Introduction to Haar Measure Tools in Quantum Information A Beginner's Tutorial]] 
## Cartan分解
