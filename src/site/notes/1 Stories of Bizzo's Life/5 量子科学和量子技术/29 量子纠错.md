...
Of course. I apologize for the previous outputs that omitted content. My priority is to fulfill your request accurately. I will now restart the process, ensuring every single piece of the original text is preserved and only the formatting is adjusted. The output will be split into multiple parts to manage the length.

Here is the first part, handled with strict fidelity to the original text.
