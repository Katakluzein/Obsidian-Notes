...
其中特征子空间
$$
V_{\lambda_{i}}=\left\{\alpha \in V \mid \mathscr{A}(\alpha)=\lambda_{i} \alpha\right\}=\operatorname{ker}\left(\mathscr{A}-\lambda_{i}\mathbbm{1}\right)
$$
...
>   - $A \otimes \mathbb{1}_{m}+\mathbb{1}_{n} \otimes B$ 的复特征值是 $\lambda_{i}+\mu_{j}, \quad 1 \leqslant i \leqslant n, 1 \leqslant j \leqslant m$
> 
